        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="row text-center">
                    <div class="col-3">
                        <div class="p-3">
                            <h4 class="text-primary fw-bold"><?= $stats['this_month_ordinances'] ?></h4>
                            <small class="text-muted">Ordinances<br>This Month</small>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="p-3">
                            <h4 class="text-success fw-bold"><?= $stats['this_month_resolutions'] ?></h4>
                            <small class="text-muted">Resolutions<br>This Month</small>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="p-3">
                            <h4 class="text-info fw-bold"><?= $stats['this_month_minutes'] ?></h4>
                            <small class="text-muted">Minutes<br>This Month</small>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="p-3">
                            <h4 class="text-warning fw-bold"><?= $stats['this_month_publications'] ?></h4>
